...
try {
    // BEST 영역 데이터 가져오기
    $queryBest = "SELECT content_code, content_img, content_name FROM contents WHERE category_large = 'knit' AND category = 'BEST'";
    $knitBestItems = db_select($queryBest); // 모든 BEST 상품 로드
...
<body>
    ...
    <div class="best-section-wrapper">
        <div class="best-section">
            <h3 style="text-align: center; font-weight: bold;">KNIT BEST ITEM</h3>
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <!-- 반복되는 BEST ITEM -->
                    <?php foreach ($knitBestItems as $bestItem): ?>
    ...
    // 현재 선택된 카테고리 이름 설정 (기본값: KNIT)
    $currentCategoryName = $categories[$currentCategory] ?? "KNIT";
    ?>
